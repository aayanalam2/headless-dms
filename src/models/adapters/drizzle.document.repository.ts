...
import { SortField, SortOrder } from "../document.repository.ts";

// ---------------------------------------------------------------------------
// createDrizzleDocumentRepository
// Drizzle/Postgres implementation of IDocumentRepository. Pass the `db`
// instance from db/connection.ts (or a test-specific client). Nothing here
// is a module-level singleton — all state lives in the injected `db`.
// ---------------------------------------------------------------------------

export function createDrizzleDocumentRepository(db: Db): IDocumentRepository {
  return {
    // -------------------------------------------------------------------------
    // Documents
    // -------------------------------------------------------------------------
